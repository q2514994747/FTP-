...
针对某些VPC网络用户，我们将所有依赖打包成了一个离线包供用户直接使用：[cos-ftp-server-stable-offline.tar.gz](http://cos-tools-offline-1253960454.cosgz.myqcloud.com/cos-ftp-server-V5-offline-stable.tar.gz)# FTP-
